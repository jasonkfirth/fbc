''
'' sys\types -- Solaris/illumos C runtime declarations
''
'' NOTICE: This file is part of the FreeBASIC Compiler package and can't
''         be included in other distributions without authorization.
''
#ifndef __crt_sys_solaris_types_bi__
#define __crt_sys_solaris_types_bi__
...
#endif
''
'' end of crt/sys/solaris/types.bi
