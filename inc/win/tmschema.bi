...
type IMAGELAYOUT as long
enum
	IL_VERTICAL = 0
	IL_HORIZONTAL = 1
end enum

type BORDERTYPE as long
enum
	BT_RECT = 0
	BT_ROUNDRECT = 1
	BT_ELLIPSE = 2
...
type TRUESIZESCALINGTYPE as long
enum
	TSST_NONE = 0
	TSST_SIZE = 1
	TSST_DPI = 2
...
type GLYPHFONTSIZINGTYPE as long
enum
	GFST_NONE = 0
	GFST_SIZE = 1
	GFST_DPI = 2
...
type RESTOREBUTTONSTATES as long
enum
...
type CLOSEBUTTONSTATES as long
enum
...
type RADIOBUTTONSTATES as long
enum
...
type HEADERITEMLEFTSTATES as long
enum
...
type HEADERITEMRIGHTSTATES as long
enum
...
type HEADERSORTARROWSTATES as long
enum
...
type TABITEMLEFTEDGESTATES as long
enum
...
type TABITEMRIGHTEDGESTATES as long
enum
...
type TABITEMBOTHEDGESSTATES as long
enum
...
type TOPTABITEMLEFTEDGESTATES as long
enum
...
type TOPTABITEMRIGHTEDGESTATES as long
enum
...
type TOPTABITEMBOTHEDGESSTATES as long
enum
...
type TRACKBARSTATES as long
enum
	TRACKBARStateFiller0
	TKS_NORMAL = 1
end enum

type TRACKSTATES as long
enum
	TRACKStateFiller0
	TRS_NORMAL = 1
end enum

type TRACKVERTSTATES as long
enum
	TRACKVERTStateFiller0
	TRVS_NORMAL = 1
end enum

type THUMBSTATES as long
enum
	THUMBStateFiller0
	TUS_NORMAL = 1
	TUS_HOT = 2
...
type THUMBBOTTOMSTATES as long
enum
...
type TICSSTATES as long
enum
	TICSStateFiller0
	TSS_NORMAL = 1
end enum

type TICSVERTSTATES as long
enum
	TICSVERTStateFiller0
	TSVS_NORMAL = 1
end enum

type TOOLTIPPARTS as long
enum
	TOOLTIPPartFiller0
	TTP_STANDARD = 1
	TTP_STANDARDTITLE = 2
...
type COMBOBOXPARTS as long
enum
	COMBOBOXPartFiller0
	CP_DROPDOWNBUTTON = 1
end enum

type COMBOBOXSTATES as long
enum
...
type CLOCKPARTS as long
enum
	CLOCKPartFiller0
	CLP_TIME = 1
end enum

type CLOCKSTATES as long
enum
	CLOCKStateFiller0
	CLS_NORMAL = 1
end enum

type TRAYNOTIFYPARTS as long
enum
...
type MOREPROGRAMSARROWSTATES as long
enum
...
type LOGOFFBUTTONSSTATES as long
enum
...
type HEADERCLOSESTATES as long
enum
...
type NORMALGROUPCOLLAPSESTATES as long
enum
...
type NORMALGROUPEXPANDSTATES as long
enum
...
type SPECIALGROUPCOLLAPSESTATES as long
enum
...
type SPECIALGROUPEXPANDSTATES as long
enum
