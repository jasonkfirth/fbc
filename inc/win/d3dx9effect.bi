...
type ID3DXEffectCompilerVtbl_
	...
	'' ID3DXConstantTable is declared in d3dx9shader.bi, which depends on this header.
	CompileShader as function(byval This as ID3DXEffectCompiler ptr, byval function as D3DXHANDLE, byval target as const zstring ptr, byval flags as DWORD, byval shader as ID3DXBuffer ptr ptr, byval error_msgs as ID3DXBuffer ptr ptr, byval constant_table as any ptr ptr) as HRESULT
end type

declare function D3DXCreateEffectPool(byval pool as ID3DXEffectPool ptr ptr) as HRESULT
declare function D3DXCreateEffect(byval device as IDirect3DDevice9 ptr, byval srcdata as const any ptr, byval srcdatalen as UINT, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectEx(byval device as IDirect3DDevice9 ptr, byval srcdata as const any ptr, byval srcdatalen as UINT, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectCompiler(byval srcdata as const zstring ptr, byval srcdatalen as UINT, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval compiler as ID3DXEffectCompiler ptr ptr, byval parse_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectFromFileExA(byval device as IDirect3DDevice9 ptr, byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectFromFileExW(byval device as IDirect3DDevice9 ptr, byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectFromFileEx alias "D3DXCreateEffectFromFileExW"(byval device as IDirect3DDevice9 ptr, byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectFromFileEx alias "D3DXCreateEffectFromFileExA"(byval device as IDirect3DDevice9 ptr, byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#endif

declare function D3DXCreateEffectFromFileA(byval device as IDirect3DDevice9 ptr, byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectFromFileW(byval device as IDirect3DDevice9 ptr, byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectFromFile alias "D3DXCreateEffectFromFileW"(byval device as IDirect3DDevice9 ptr, byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectFromFile alias "D3DXCreateEffectFromFileA"(byval device as IDirect3DDevice9 ptr, byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#endif

declare function D3DXCreateEffectFromResourceExA(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectFromResourceExW(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectFromResourceEx alias "D3DXCreateEffectFromResourceExW"(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectFromResourceEx alias "D3DXCreateEffectFromResourceExA"(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval skip_constants as const zstring ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#endif

declare function D3DXCreateEffectFromResourceA(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectFromResourceW(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectFromResource alias "D3DXCreateEffectFromResourceW"(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectFromResource alias "D3DXCreateEffectFromResourceA"(byval device as IDirect3DDevice9 ptr, byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval pool as ID3DXEffectPool ptr, byval effect as ID3DXEffect ptr ptr, byval compilation_errors as ID3DXBuffer ptr ptr) as HRESULT
#endif

declare function D3DXCreateEffectCompilerFromFileA(byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectCompilerFromFileW(byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectCompilerFromFile alias "D3DXCreateEffectCompilerFromFileW"(byval srcfile as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectCompilerFromFile alias "D3DXCreateEffectCompilerFromFileA"(byval srcfile as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
#endif

declare function D3DXCreateEffectCompilerFromResourceA(byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
declare function D3DXCreateEffectCompilerFromResourceW(byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT

#ifdef UNICODE
	declare function D3DXCreateEffectCompilerFromResource alias "D3DXCreateEffectCompilerFromResourceW"(byval srcmodule as HMODULE, byval srcresource as const wstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
#else
	declare function D3DXCreateEffectCompilerFromResource alias "D3DXCreateEffectCompilerFromResourceA"(byval srcmodule as HMODULE, byval srcresource as const zstring ptr, byval defines as const D3DXMACRO ptr, byval include as any ptr, byval flags as DWORD, byval effectcompiler as ID3DXEffectCompiler ptr ptr, byval parseerrors as ID3DXBuffer ptr ptr) as HRESULT
#endif
