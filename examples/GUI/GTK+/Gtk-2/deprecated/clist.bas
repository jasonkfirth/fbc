...
'
' Reviewed by TJF (2011), Clist is deprecated -> use GtkListView instead
...
' ==============================================
  ...
  g_signal_connect_swapped (G_OBJECT (button_add), "clicked", _
                            G_CALLBACK (@button_add_clicked), clist)
  g_signal_connect_swapped (G_OBJECT (button_clear), "clicked", _
                            G_CALLBACK (@button_clear_clicked), clist)
  g_signal_connect_swapped (G_OBJECT (button_hide_show), "clicked", _
