...
' ==============================================
    ...
    g_signal_connect( G_OBJECT(drawing_area), "expose_event", _
                      G_CALLBACK(@expose_event), NULL)
    g_signal_connect( G_OBJECT(drawing_area), "configure_event", _
    G_CALLBACK(@configure_event), NULL)

    ' Event signals
    g_signal_connect( G_OBJECT(drawing_area), "motion_notify_event", _
                      G_CALLBACK(@motion_notify_event), NULL)
    g_signal_connect( G_OBJECT(drawing_area), "button_press_event", _
