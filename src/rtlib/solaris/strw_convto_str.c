/*
    ...
    Purpose:
        ...
        Convert wide strings to narrow strings when building for Solaris/illumos.

    Responsibilities:

        * convert FB_WCHAR input to UTF-8 using the runtime converter
        * guarantee a NUL-terminated output within the caller-provided limit
        * preserve fallback behavior when conversion cannot allocate

    This file intentionally does not contain:

        * host locale handling for mbstowcs()/wcstombs()
*/
