/*
 * Project: FreeBASIC RISC OS Unicode runtime
 * ------------------------------------------
 *
 * File: fb_unicode.h
 *
 * Purpose:
 *
 *     Define the wide-character runtime interface used with UnixLib.
 *
 * Responsibilities:
 *
 *     - define the runtime UTF and wide-character types
 *     - provide UnixLib-safe numeric formatting and integer parsing
 *     - provide deterministic ASCII classification and case mapping
 *     - expose the common FreeBASIC wide-string helper interface
 *
 * This file intentionally does NOT contain:
 *
 *     - locale initialization
 *     - string allocation policy outside temporary wide strings
