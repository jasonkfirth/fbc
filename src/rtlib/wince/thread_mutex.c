...
FBCALL FBMUTEX *fb_MutexCreate( void )
{
	...
	/* COREDLL consistently exports the wide-character entry point, including
	   on older MIPS images which omit the ANSI compatibility alias. */
	mutex->id = CreateSemaphoreW( NULL, 1, 1, NULL );
