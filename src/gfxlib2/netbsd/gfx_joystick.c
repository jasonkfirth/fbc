/*
    FreeBASIC gfxlib2 NetBSD joystick backend
    -----------------------------------------
    ...
    Purpose:
        ...
        Provide GETJOYSTICK support on NetBSD systems that expose the
        Linux joydev-compatible /dev/input/jsN interface.

    Responsibilities:

        - select the shared Unix joydev implementation for NetBSD builds
