...
extern void fb_hWin32StopThread(void);
extern void fb_hWin32Lock(void);
extern void fb_hWin32Unlock(void);
extern void fb_hWin32EnableWindowScaling(int enable);
extern int fb_hWin32IsWindowScalingEnabled(void);
extern void fb_hWin32UpdateWindowLayout(void);
extern void fb_hWin32GetWindowScaledRect(RECT *rect);
