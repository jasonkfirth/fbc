...
enum
	...
	FB_CPUFAMILY_M68K
	FB_CPUFAMILY_MIPS32
	FB_CPUFAMILY_MIPS32EL
	FB_CPUFAMILY_MIPS64
	FB_CPUFAMILY_MIPS64EL
	FB_CPUFAMILY__COUNT
end enum
...
#elseif defined(__FB_ILLUMOS__)
const FB_HOST_EXEEXT        = ""
const FB_HOST_PATHDIV       = "/"
const FB_HOST_DEFAULT_TARGET = FB_COMPTARGET_ILLUMOS
...
#elseif defined(__FB_WII__)
const FB_HOST_EXEEXT        = ""
const FB_HOST_PATHDIV       = "/"
const FB_HOST_DEFAULT_TARGET = FB_COMPTARGET_WII
#elseif defined(__FB_RISCOS__)
const FB_HOST_EXEEXT        = ""
const FB_HOST_PATHDIV       = "/"
const FB_HOST_DEFAULT_TARGET = FB_COMPTARGET_RISCOS
#elseif defined(__FB_AROS__)
const FB_HOST_EXEEXT        = ""
const FB_HOST_PATHDIV       = "/"
const FB_HOST_DEFAULT_TARGET = FB_COMPTARGET_AROS
#else
...
const FB_DEFAULT_CPUTYPE_RISCV32 = FB_CPUTYPE_RISCV32
...
const FB_DEFAULT_CPUTYPE_MIPS32  = FB_CPUTYPE_MIPS32
const FB_DEFAULT_CPUTYPE_MIPS32EL = FB_CPUTYPE_MIPS32EL
const FB_DEFAULT_CPUTYPE_MIPS64  = FB_CPUTYPE_MIPS64
const FB_DEFAULT_CPUTYPE_MIPS64EL = FB_CPUTYPE_MIPS64EL
...
'' default 32 and 64 bit CPU's (based on defaults above)
	...
	#endif
#elseif defined(__FB_RISCV32__)
	const FB_DEFAULT_CPUTYPE32 = FB_DEFAULT_CPUTYPE_RISCV32
	...
	const FB_DEFAULT_CPUTYPE32 = FB_DEFAULT_CPUTYPE_M68K
	'' There is no 64-bit member of the Motorola 68000 family.  This value is
	'' only a compile-time placeholder for shared default-selection code.
	const FB_DEFAULT_CPUTYPE64 = FB_DEFAULT_CPUTYPE_M68K
#elseif defined(__FB_MIPS__)
	#if defined(__FB_BIGENDIAN__)
		const FB_DEFAULT_CPUTYPE32 = FB_DEFAULT_CPUTYPE_MIPS32
		const FB_DEFAULT_CPUTYPE64 = FB_DEFAULT_CPUTYPE_MIPS64
	#else
		const FB_DEFAULT_CPUTYPE32 = FB_DEFAULT_CPUTYPE_MIPS32EL
		const FB_DEFAULT_CPUTYPE64 = FB_DEFAULT_CPUTYPE_MIPS64EL
	#endif
