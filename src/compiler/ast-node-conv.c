...
int64 ASTCHECKCONVNONPTRTOPTR( int64 TO_DTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) != 0ll) goto label$70;
	{
		...
		label$79:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 624ll)) goto label$77;
		{
			fb$result$1 = 0ll;
			goto label$67;
		}
...
static int64 HCHECKPTR( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	if( (EXPR_DTYPE$1 & 480ll) == 0ll) goto label$86;
	{
		...
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$97$2 * 56ll)) != 0ll) goto label$89;
		{
			...
			label$378:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 624ll)) goto label$96;
			{
				goto label$81;
			}
			label$96:;
