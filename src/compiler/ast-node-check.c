...
static void fb_ctor__astznodezcheck( void ) __attribute__(( constructor ));
static void _ZN11TSTRSETITEMaSERKS_( struct $11TSTRSETITEM*, struct $11TSTRSETITEM* );
void ASTDELNODE( struct $7ASTNODE* );
struct $7ASTNODE* ASTNEWASSIGN( struct $7ASTNODE*, struct $7ASTNODE*, $9AST_OPOPT );
struct $7ASTNODE* ASTNEWVAR( struct $8FBSYMBOL*, int64, int64, struct $8FBSYMBOL* );
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE*, struct $7ASTNODE*, struct $7ASTNODE*, int64, char*, struct $8FBSYMBOL* );
struct $7ASTNODE* ASTNEWPTRCHK( struct $7ASTNODE*, int64, char* );
...
struct $7ASTNODE* RTLARRAYBOUNDSCHECK( struct $7ASTNODE*, struct $7ASTNODE*, struct $7ASTNODE*, struct $7ASTNODE*, int64, char*, char* );
struct $7ASTNODE* RTLNULLPTRCHECK( struct $7ASTNODE*, int64, char* );
...
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE* L$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, int64 LINENUM$1, char* FILENAME$1, struct $8FBSYMBOL* SYM$1 )
{
	int64 TMP$95$1;
	...
	ARRAYEXPR$1 = (struct $7ASTNODE*)0ull;
	if( LB$1 != (struct $7ASTNODE*)0ull) goto label$12;
	TMP$95$1 = (int64)-(UB$1 == (struct $7ASTNODE*)0ull);
	goto label$27;
	label$12:;
	TMP$95$1 = 0ll;
	label$27:;
	if( TMP$95$1 == 0ll) goto label$14;
	{
		if( *(int64*)SYM$1 != 12ll) goto label$16;
		{
			fb$result$1 = L$1;
			goto label$11;
		}
		...
		label$16:;
		{
			struct $7ASTNODE* vr$3 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			struct $7ASTNODE* vr$4 = ASTNEWNIDXARRAY( vr$3 );
			ARRAYEXPR$1 = vr$4;
		}
		label$15:;
	}
	...
	label$14:;
	{
		if( *(int64*)LB$1 != 16ll) goto label$18;
		{
			if( *(int64*)L$1 != 16ll) goto label$20;
			{
				if( *(int64*)((uint8*)L$1 + 40ll) >= *(int64*)((uint8*)LB$1 + 40ll)) goto label$22;
				{
				...
				label$22:;
				label$21:;
				if( *(int64*)((uint8*)L$1 + 40ll) <= *(int64*)((uint8*)UB$1 + 40ll)) goto label$24;
				{
					fb$result$1 = (struct $7ASTNODE*)0ull;
					goto label$11;
				}
			...
			label$20:;
			label$19:;
			if( *(int64*)((uint8*)LB$1 + 40ll) != 0ll) goto label$26;
			{
				ASTDELNODE( LB$1 );
				LB$1 = (struct $7ASTNODE*)0ull;
			}
			label$26:;
			label$25:;
		}
	...
	label$13:;
	struct $7ASTNODE* vr$14 = ASTNEWNODE( 31ll, *(int64*)((uint8*)L$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) );
	N$1 = vr$14;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = L$1;
	struct $8FBSYMBOL* vr$18 = SYMBADDTEMPVAR( *(int64*)((uint8*)L$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = vr$18;
	struct $7ASTNODE* vr$22 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$23 = RTLARRAYBOUNDSCHECK( vr$22, ARRAYEXPR$1, LB$1, UB$1, LINENUM$1, FILENAME$1, *(char**)((uint8*)SYM$1 + 32ll) );
	*(struct $7ASTNODE**)((uint8*)N$1 + 120ll) = vr$23;
	label$11:;
	return fb$result$1;
}

struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	if( ((int64)-(L$1 == (struct $7ASTNODE*)0ull) | (int64)-(R$1 == (struct $7ASTNODE*)0ull)) == 0ll) goto label$31;
	{
	...
	label$31:;
	label$30:;
	struct $7ASTNODE* vr$7 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$8 = ASTNEWASSIGN( vr$7, L$1, 64ll );
	T$1 = vr$8;
	ASTLOAD( T$1 );
	ASTDELNODE( T$1 );
	struct $6IRVREG* vr$9 = ASTLOAD( R$1 );
	VR$1 = vr$9;
	ASTDELNODE( R$1 );
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll) goto label$33;
	{
		struct $8FBSYMBOL* vr$10 = SYMBADDLABEL( (char*)0ull, 4ll );
		LABEL$1 = vr$10;
		struct $6IRVREG* vr$11 = (*(tmp$71*)((uint8*)&IR$ + 456ll))( 8ll, (struct $8FBSYMBOL*)0ull, 0ll );
		(*(tmp$52*)((uint8*)&IR$ + 184ll))( 45ll, VR$1, vr$11, (struct $6IRVREG*)0ull, LABEL$1, 0ll );
		(*(tmp$54*)((uint8*)&IR$ + 272ll))( VR$1 );
		(*(tmp$43*)((uint8*)&IR$ + 128ll))( LABEL$1 );
	}
	label$33:;
	label$32:;
	struct $7ASTNODE* vr$13 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	T$1 = vr$13;
	struct $6IRVREG* vr$14 = ASTLOAD( T$1 );
	fb$result$1 = vr$14;
	ASTDELNODE( T$1 );
	label$29:;
	return fb$result$1;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, struct $8FBSYMBOL* SYM$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$34:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844696ll) + 16752ll), (char*)((uint8*)&ENV$ + 640ll), SYM$1 );
	fb$result$1 = vr$3;
	label$35:;
	return fb$result$1;
}

struct $7ASTNODE* ASTNEWPTRCHK( struct $7ASTNODE* L$1, int64 LINENUM$1, char* FILENAME$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$36:;
	...
	if( *(int64*)L$1 != 16ll) goto label$39;
	{
		fb$result$1 = L$1;
		goto label$37;
	}
	...
	struct $7ASTNODE* vr$4 = ASTNEWNODE( 32ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$4;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = L$1;
	struct $8FBSYMBOL* vr$6 = SYMBADDTEMPVAR( DTYPE$1, SUBTYPE$1 );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = vr$6;
	struct $7ASTNODE* vr$9 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$10 = RTLNULLPTRCHECK( vr$9, LINENUM$1, FILENAME$1 );
	*(struct $7ASTNODE**)((uint8*)N$1 + 120ll) = vr$10;
	label$37:;
	return fb$result$1;
}

struct $6IRVREG* ASTLOADPTRCHK( struct $7ASTNODE* N$1 )
{
	struct $6IRVREG* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$40:;
	...
	L$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 112ll);
	R$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
	if( ((int64)-(L$1 == (struct $7ASTNODE*)0ull) | (int64)-(R$1 == (struct $7ASTNODE*)0ull)) == 0ll) goto label$43;
	{
		fb$result$1 = (struct $6IRVREG*)0ull;
		goto label$41;
	}
	...
	label$42:;
	struct $7ASTNODE* vr$7 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$8 = ASTNEWASSIGN( vr$7, L$1, 80ll );
	T$1 = vr$8;
	ASTLOAD( T$1 );
	ASTDELNODE( T$1 );
	struct $6IRVREG* vr$9 = ASTLOAD( R$1 );
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	struct $7ASTNODE* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$46:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844696ll) + 16752ll), (char*)((uint8*)&ENV$ + 640ll) );
	fb$result$1 = vr$3;
	label$47:;
	return fb$result$1;
}
