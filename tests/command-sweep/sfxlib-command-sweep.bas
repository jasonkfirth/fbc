...
'' In the Node.js harness the browser WebAudio driver cannot initialize.
'' Select the null backend that SfxTestUseNullDriver() already requested.
result = device select( 1 )
#else
