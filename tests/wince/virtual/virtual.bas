''
'' FreeBASIC Windows CE virtual-method tests
'' ------------------------------------------
''
'' File: tests/wince/virtual/virtual.bas
''
'' Purpose:
''
''     Run the complete virtual-method test baseline with the Windows CE ABI.
''
'' Responsibilities:
''
''     - exercise virtual dispatch, inheritance, RTTI, and virtual destructors
''     - verify C and C++ external member-procedure calling conventions
''     - preserve the shared virtual-method coverage for Windows CE
''
'' This file intentionally does NOT contain:
''
''     - compiler implementation details
''     - desktop x86 thiscall assumptions
''     - Windows CE operating-system API tests
''
#include "fbcunit.bi"
...
SUITE( fbc_tests.virtual_.virtual_ )
	...
	TEST_GROUP( externCxx )
		...
		'' ARM Windows CE uses the platform C ABI for C++ member procedures.
...
'' end of tests/wince/virtual/virtual.bas
