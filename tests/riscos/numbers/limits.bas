...
SUITE( fbc_tests.numbers.limits )
	...
	TEST( default )
		...
		scope
			...
			dim as ulong ptr tst_dbl_min_words = cast( ulong ptr, @dbl_min )
			dim as ulong ptr tst_dbl_max_words = cast( ulong ptr, @dbl_max )
			dim as ulongint tst_dbl_min_bits = _
				(culngint(tst_dbl_min_words[0]) shl 32) or tst_dbl_min_words[1]
			dim as ulongint tst_dbl_max_bits = _
				(culngint(tst_dbl_max_words[0]) shl 32) or tst_dbl_max_words[1]
