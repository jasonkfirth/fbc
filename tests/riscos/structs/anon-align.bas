...
SUITE( fbc_tests.structs.anon_align )
	...
	'' On 32bit Win32/MinGW, ARM except RISC OS APCS, JS/wasm, Xbox and PowerPC,
	'' doubles/longints are aligned to 8, but on 32bit x86 Linux, BSD
	'' and DOS, and on RISC OS APCS, doubles/longints are aligned to 4.
